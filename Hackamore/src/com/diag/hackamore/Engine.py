                ...
                if Event.END in event:
                    ...
                    if flavor == Event.CONFBRIDGEEND:
                        ...
                        if not Event.CHANNEL in event:
                            ...
                            if not debug:
                                self.state.confbridgejoin(uniqueid, channel, conference)
                        ...
                        if not Event.CHANNEL in event:
                            ...
                            if not debug:
                                self.state.confbridgeleave(uniqueid, channel, conference)
                        ...
                        if not Event.SUBEVENT in event:
                            ...
                            if not debug:
                                self.state.dial(uniqueid, channel, destuniqueid, destination)
                        ...
                        if not Event.CHANNEL in event:
                            ...
                            if not debug:
                                self.state.hangup(uniqueid, channel)
                    elif flavor == Event.HANGUP:
                        ...
                        if not Event.CHANNEL in event:
                            ...
                            if not debug:
                                self.state.newstate(uniqueid, channel, channelstate, channelstatedesc)
                        ...
                        if not Event.CHANNEL in event:
                            ...
                            if not debug:
                                self.state.rename(uniqueid, channel, newname)
